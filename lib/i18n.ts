...
export const dictionaries: Record<Lang, Dict> = {
  de: {
    ...
    "plan.offline": "Nur auf diesem Gerät gespeichert – Cloud nicht erreichbar.",
    "plan.offlineEmpty": "Der Server ist nicht erreichbar – ein bereits gespeicherter Plan kann gerade nicht geladen werden.",
    ...
    "auth.error.unreachable": "Anmeldung ist gerade nicht möglich – der Server ist nicht erreichbar. Bitte versuche es später erneut.",
  ...
  en: {
    ...
    "plan.offline": "Saved on this device only – the cloud is unreachable.",
    "plan.offlineEmpty": "The server is unreachable – if you already have a saved plan, it can't be loaded right now.",
    ...
    "auth.error.unreachable": "Sign-in isn't available right now – the server is unreachable. Please try again later.",
